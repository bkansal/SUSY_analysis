...
void makeDatacard_SBins(double mGl,double mNLSP,TString sigFile,char histname1[1000],char histname[1000]){
  char name[1000];
  ...
  f[1] = new TFile("WGJetsToLNuG_v18.root");
  f[2] = new TFile("WJetsToLNu_v18.root");
  f[3] = new TFile("TTJetsHT_v18.root");
  f[4] = new TFile("TTGJets_v18.root");
  f[5] = new TFile("ZGZJ_NuNuG_v18.root");
  //f[5] = new TFile("ZGJetsToNuNuG_v17.root");
  //f[6] = new TFile("ZJetsToNuNu_v17.root");
  f[6] = new TFile("GJetsQCD_new_v18.root");
