...
void AnalyzeLightBSM::EventLoop(const char *data,const char *inputFileList) {
  ...
  int reg_A=0,reg_B=0,reg_C=0,reg_D=0,valid=0;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    if(s_data.Contains("FastSim") && s_data.Contains("TChiNG") )
    ...
    ////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////                                                                                              
    //========= hadAk8jet -> removing jets which are matched with photon within mindr 0.3 =====//                                                                                          
    //////////////////////////////////////////////////////////////////////////////////////////                                                                                              
    ...
    h_BTags_nocut->Fill(nbjets,wt);
    h_hadAk8Mass_nocut->Fill(Ak8Mass,wt);
    int sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_nocut->Fill(sBin6_50bin_,wt);
    //    h_SBins_v6_CD_EW_50bin_nocut_elec1_closure->Fill(sBin6_50bin_,wt);                                                                   

    ////////////////////////////////////////////////////
    ///////////////////////////////////////////////////
    bool stitch=true;
    if(stitch && !s_data.Contains("data"))
      {
	genphomatch_before++;
	...
	if(s_data=="genprompt" || s_data.Contains("WG_17"))
	  {
	    if(!hasGenPromptPhoton)
	      {
		if(jentry==0)cout<<"**********processing "<<s_data<<" with non-prompt Gen photon"<<endl;
	...
	//	cout<<jentry<<" : (*Photons_nonPrompt)["<<bestPhotonIndxAmongPhotons<<" ] = "<<(*Photons_nonPrompt)[bestPhotonIndxAmongPhotons]<<endl;
	/*
	if((*Photons_nonPrompt)[bestPhotonIndxAmongPhotons] && s_data.Contains("GJets")) continue;
	if((!(*Photons_nonPrompt)[bestPhotonIndxAmongPhotons] && madMinDeltaRStatus==1 && madMinPhotonDeltaR > 0.4) && s_data.Contains("QCD")) continue;
	if((hasGenPromptPhoton && madMinDeltaRStatus==1 && madMinPhotonDeltaR > 0.5) && (s_data.Contains("ZJets"))) continue;
        if((hasGenPromptPhoton && madMinPhotonDeltaR <= 0.5) && (s_data.Contains("ZG_v17"))) continue;
	*/
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_genpho->Fill(bestPhoton.Pt(),wt);
    h_MET_genpho->Fill(MET,wt);
    h_METvBin_genpho->Fill(MET,wt);
    h_nJets_genpho->Fill(nHadJets,wt);
    h_ST_genpho->Fill(ST,wt);
    h_BTags_genpho->Fill(nbjets,wt);
    h_hadAk8Mass_genpho->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_genpho->Fill(sBin6_50bin_,wt);
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_phopt->Fill(bestPhoton.Pt(),wt);
    h_MET_phopt->Fill(MET,wt);
    h_METvBin_phopt->Fill(MET,wt);
    h_nJets_phopt->Fill(nHadJets,wt);
    h_ST_phopt->Fill(ST,wt);
    h_BTags_phopt->Fill(nbjets,wt);
    h_hadAk8Mass_phopt->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_phopt->Fill(sBin6_50bin_,wt);
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_MET200->Fill(bestPhoton.Pt(),wt);
    h_MET_MET200->Fill(MET,wt);
    h_METvBin_MET200->Fill(MET,wt);
    h_nJets_MET200->Fill(nHadJets,wt);
    h_ST_MET200->Fill(ST,wt);
    h_BTags_MET200->Fill(nbjets,wt);
    h_hadAk8Mass_MET200->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_MET200->Fill(sBin6_50bin_,wt);
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_nj2->Fill(bestPhoton.Pt(),wt);
    h_MET_nj2->Fill(MET,wt);
    h_METvBin_nj2->Fill(MET,wt);
    h_nJets_nj2->Fill(nHadJets,wt);
    h_ST_nj2->Fill(ST,wt);
    h_BTags_nj2->Fill(nbjets,wt);
    h_hadAk8Mass_nj2->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_nj2->Fill(sBin6_50bin_,wt);
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_ST300->Fill(bestPhoton.Pt(),wt);
    h_MET_ST300->Fill(MET,wt);
    h_METvBin_ST300->Fill(MET,wt);
    h_nJets_ST300->Fill(nHadJets,wt);
    h_ST_ST300->Fill(ST,wt);
    h_BTags_ST300->Fill(nbjets,wt);
    h_hadAk8Mass_ST300->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_ST300->Fill(sBin6_50bin_,wt);
    ...
    ////////////////////////////////////////////////                                                                                                                                       
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_aftertrg->Fill(bestPhoton.Pt(),wt);
    h_MET_aftertrg->Fill(MET,wt);
    h_METvBin_aftertrg->Fill(MET,wt);
    h_nJets_aftertrg->Fill(nHadJets,wt);
    h_ST_aftertrg->Fill(ST,wt);
    h_BTags_aftertrg->Fill(nbjets,wt);
    h_hadAk8Mass_aftertrg->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_aftertrg->Fill(sBin6_50bin_,wt);
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_METfilters->Fill(bestPhoton.Pt(),wt);
    h_MET_METfilters->Fill(MET,wt);
    h_METvBin_METfilters->Fill(MET,wt);
    h_nJets_METfilters->Fill(nHadJets,wt);
    h_ST_METfilters->Fill(ST,wt);
    h_BTags_METfilters->Fill(nbjets,wt);
    h_hadAk8Mass_METfilters->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_METfilters->Fill(sBin6_50bin_,wt);
    //    h_SBins_v6_CD_EW_50bin_METfilters_elec1_closure->Fill(sBin6_50bin_,wt);
   ...
   ////////////////////////////////////////////////                                                                                                                                        
   ////////////////////////////////////////////////                                                                                                                                        
   h_BestPhotonPt_madHT->Fill(bestPhoton.Pt(),wt);
   h_MET_madHT->Fill(MET,wt);
   h_METvBin_madHT->Fill(MET,wt);
   h_nJets_madHT->Fill(nHadJets,wt);
   h_ST_madHT->Fill(ST,wt);
   h_BTags_madHT->Fill(nbjets,wt);
   h_hadAk8Mass_madHT->Fill(Ak8Mass,wt);
   sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
   h_SBins_v6_CD_EW_50bin_madHT->Fill(sBin6_50bin_,wt);
   ...
   ////////////////////////////////////////////////                                                                                                                                        
   ////////////////////////////////////////////////                                                                                                                                        
   h_BestPhotonPt_nolep->Fill(bestPhoton.Pt(),wt);
   h_MET_nolep->Fill(MET,wt);
   h_METvBin_nolep->Fill(MET,wt);
   h_nJets_nolep->Fill(nHadJets,wt);
   h_ST_nolep->Fill(ST,wt);
   h_BTags_nolep->Fill(nbjets,wt);
   h_hadAk8Mass_nolep->Fill(Ak8Mass,wt);
   sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
   h_SBins_v6_CD_EW_50bin_nolep->Fill(sBin6_50bin_,wt);
   ...
   //////////////////////////////////////////////                                                                                                                                          
   h_BestPhotonPt_noisotrack->Fill(bestPhoton.Pt(),wt);
   h_MET_noisotrack->Fill(MET,wt);
   h_METvBin_noisotrack->Fill(MET,wt);
   h_nJets_noisotrack->Fill(nHadJets,wt);
   h_ST_noisotrack->Fill(ST,wt);
   h_BTags_noisotrack->Fill(nbjets,wt);
   h_hadAk8Mass_noisotrack->Fill(Ak8Mass,wt);
   sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
   h_SBins_v6_CD_EW_50bin_noisotrack->Fill(sBin6_50bin_,wt);
   ...
   ////////////////////////////////////////////////                                                                         
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_ISR->Fill(bestPhoton.Pt(),wt);
    h_MET_ISR->Fill(MET,wt);
    h_METvBin_ISR->Fill(MET,wt);
    h_nJets_ISR->Fill(nHadJets,wt);
    h_ST_ISR->Fill(ST,wt);
    h_BTags_ISR->Fill(nbjets,wt);
    h_hadAk8Mass_ISR->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_ISR->Fill(sBin6_50bin_,wt);

    //////////////////////////////////////////////                                                                                                                                         
    //////////////////////////////////////////////                                                                                                                                          
    TLorentzVector Met;
    Met.SetPtEtaPhiE(MET,0,METPhi,0);
    double mT= 0.0, dPhi_METjet3=5, dPhi_METjet4=5, dPhi_METjet1=5, dPhi_METjet2=5, dPhi_phojet1=5, dPhi_phojet2=5, dPhi_phoMET=5;
    ...
    if(hadJets.size()>2) dPhi_METjet3 = abs(DeltaPhi(METPhi,(hadJets)[2].Phi()));
    if(hadJets.size()>3) dPhi_METjet4 = abs(DeltaPhi(METPhi,(hadJets)[3].Phi()));
    ...
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_phojet->Fill(bestPhoton.Pt(),wt);
    h_MET_phojet->Fill(MET,wt);
    h_METvBin_phojet->Fill(MET,wt);
    h_nJets_phojet->Fill(nHadJets,wt);
    h_ST_phojet->Fill(ST,wt);
    h_BTags_phojet->Fill(nbjets,wt);
    h_hadAk8Mass_phojet->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_phojet->Fill(sBin6_50bin_,wt);
    ...
    bool region_A=false, region_B=false, region_C=false, region_D=false;
    if(!bestPhoHasPxlSeed && bestPhoton.Pt()>=100 && ST>300 && nHadJets>=2 && MET > 200 && NElectrons==0 && NMuons==0 &&((isoElectronTracks==0)&&(isoMuonTracks==0)&&(isoPionTracks==0)))
      process =true;
    else process=false;

    if(process && MET<300 && !(dPhi_METjet1>0.3 && dPhi_METjet2>0.3) )
      {      region_A=true; reg_A++;}
    else if(process && MET>=300 && !(dPhi_METjet1>0.3 && dPhi_METjet2>0.3) )
      {      region_B=true; reg_B++;}
    else if(process && MET<300 && (dPhi_METjet1>0.3 && dPhi_METjet2>0.3) )
      {      region_C=true; reg_C++;}
    else if(process && MET>=300 && (dPhi_METjet1>0.3 && dPhi_METjet2>0.3) )
    ...
    //if(region_B || region_C || region_D) {
      //      cout<<"Event is invalid !!!!!"<<endl;
    if(!(region_C || region_D))  continue;    
      //    }
    ////////////////////////////////////////////////                                                                                                                                        
    ////////////////////////////////////////////////                                                                                                                                        
    h_BestPhotonPt_dphi->Fill(bestPhoton.Pt(),wt);
    h_MET_dphi->Fill(MET,wt);
    h_METvBin_dphi->Fill(MET,wt);
    h_nJets_dphi->Fill(nHadJets,wt);
    h_ST_dphi->Fill(ST,wt);
    h_BTags_dphi->Fill(nbjets,wt);
    h_hadAk8Mass_dphi->Fill(Ak8Mass,wt);
    sBin6_50bin_= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
    h_SBins_v6_CD_EW_50bin_dphi->Fill(sBin6_50bin_,wt);
    ...
    //Minimum Btags                                                                                                                                                         
	 ...
	 if(s_data.Contains("FastSim")) {
	   ...
	   if(s_data.Contains("2016")) btagcorr.SetCalibFastSim("btag/deepcsv_13TEV_16SL_18_3_2019.csv");
	   if(s_data.Contains("2017")) btagcorr.SetCalibFastSim("btag/deepcsv_13TEV_17SL_18_3_2019.csv");
	   if(s_data.Contains("2018")) btagcorr.SetCalibFastSim("btag/deepcsv_13TEV_18SL_7_5_2019.csv");
	 }
	 if(!s_data.Contains("data")){
    ...
    if (process){
      //      if(s_data.Contains("TChi") && EWselection && !(EWselec && EWselec1)) continue;
      evtSurvived++;
	...
	h_JetEta1->Fill(hadJets[0].Eta(),wt);
      ...
      if(applybTagSFs && (s_data.Contains("v17")||s_data.Contains("FastSim"))){
	nbjets=0;
	h_MET->Fill(MET,wt*prob0);
	h_nJets->Fill(nHadJets,wt*prob0);
	h_ST->Fill(ST,wt*prob0);
	h_BestPhotonPt_dphi->Fill(bestPhoton.Pt(),wt*prob0);
	sBin6_50bin= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
	h_SBins_v6_CD_EW_50bin->Fill(sBin6_50bin,wt*prob0);
	h_SBins_v6_CD_EW_50bin_elec1_closure->Fill(sBin6_50bin,wt*prob0);
	h_hadAk8Mass->Fill(Ak8Mass,wt*prob0);
	
        nbjets=1;
        h_MET->Fill(MET,wt*prob1);
        h_nJets->Fill(nHadJets,wt*prob1);
        h_ST->Fill(ST,wt*prob1);
        h_BestPhotonPt_dphi->Fill(bestPhoton.Pt(),wt*prob1);
	sBin6_50bin= getBinNoV6_EWplusSP_CR(EWselec,EWselec1 ,EWselec_Htag,EWselec_Wtag,nHadJets,nbjets);
        h_SBins_v6_CD_EW_50bin->Fill(sBin6_50bin,wt*prob1);
        h_SBins_v6_CD_EW_50bin_elec1_closure->Fill(sBin6_50bin,wt*prob1);
        h_hadAk8Mass->Fill(Ak8Mass,wt*prob1);
      ...
      else
	{
	  ...
	  h_SBins_v6_CD_EW_50bin_elec1_closure->Fill(sBin6_50bin,wt);
