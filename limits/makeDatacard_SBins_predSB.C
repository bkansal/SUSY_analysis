...
void makeDatacard_SBins_predSB(double mGl,double mNLSP,TString sigFile,char histname1[1000],char histname[1000]){
  char name[1000];
   ...
   */
    ...
    outf<<"sys_JEC"<<" lnN "<<" - "<<1 + 0.07<<" "<<1 + 0.13<<" - - - "<<1 + 0.07<<" "<<1 + 0.13<<" - - "<<endl;
    outf<<"sys_JER"<<" lnN "<<" - "<<1 + 0.04<<" "<<1 + 0.16<<" - - - "<<1 + 0.04<<" "<<1 + 0.16<<" - - "<<endl;
    */
    outf<<endl<<"------------"<<endl;
    int p=1;
    if(p==1)
