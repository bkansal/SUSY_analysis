...
anaExe2="analyzeLightBSM_lowdphi"
anaArg="FastSim"
#exeAtWorker="worker_SP.sh"
exeAtWorker="worker_pred.sh"
#dataSetType="T6ttZg"
...
ext="Summer16v3"
cp CD/*.root . 
hist1=pred_data_nosys

#rm -rf /eos/uscms/store/user/bkansal/myProduction/limits_rootout/${dataSetType}/njet6/${hist1}/*.root
#mkdir /eos/uscms/store/user/bkansal/myProduction/limits_rootout/${dataSetType}/njet6
#mkdir /eos/uscms/store/user/bkansal/myProduction/limits_rootout/${dataSetType}/njet6/${hist1}
#mkdir /eos/uscms/store/user/bkansal/myProduction/limits_rootout/T5bbbbZg/${dataSetType}/${hist1}/dataCards
mkdir /eos/uscms/store/user/bkansal/myProduction/limits_rootout/${dataSetType}/Final
rm -rf /eos/uscms/store/user/bkansal/myProduction/limits_rootout/${dataSetType}/Final/${hist1}
...
filesToTransfer="makeDatacard_SBins_predSB_sys.C,makeDatacard_SBins_predSB.C,makeDatacard_SBins_predall.C,higgsAnalysis.tar,EWK_LL.root,EWK_FR.root,EWK_Zin.root,QCD.root,LL.root,FR.root,Zin.root,Data.root,Data_lowdphi.root,Data_lowMET.root,${anaExe},${anaExe2},PileupHistograms_2018_69mb_pm5.root,PileupHistograms_2016_69mb_pm5.root,PileupHistograms_2017_69mb_pm5.root,T5bbbbZg_MassScan.root,T5qqqqHg_Summer16v3_MassScan.root,TChiWG_MassScan.root,TChiNG_MassScan.root,T5ttttZG_Summer16v3Fast_MassScan.root,T6ttZG_Summer16v3_MassScan.root"

#filesToTransfer="makeDatacard_SBins_pred.C,higgsAnaTChiWG_MassScan.rootlysis.tar,Lostlepton_highdphi.root,Fakerate_highdphi.root,Zinvi_highdphi.root,QCD_Multi.root,${anaExe},PileupHistograms_2018_69mb_pm5.root,PileupHistograms_2016_69mb_pm5.root,PileupHistograms_2017_69mb_pm5.root,T5bbbbZg_MassScan.root"
