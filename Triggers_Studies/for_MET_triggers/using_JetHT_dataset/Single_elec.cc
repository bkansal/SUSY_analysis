...
void Single_elec::EventLoop(const char *data,const char *inputFileList) {
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    if( (*TriggerPass)[13]==1)         { h_selectBaselineYields_->Fill(1); passTrg = true;}      
    else if( (*TriggerPass)[14]==1)         { h_selectBaselineYields_->Fill(2); passTrg = true;}
    //HT triggers
    else if( (*TriggerPass)[67]==1)         { h_selectBaselineYields_->Fill(3); passTrg = true;}
    ...
    //    if( (*TriggerPass)[110]==1 && (*TriggerPrescales)[110]==1 )      { h_selectBaselineYields_->Fill(25); passReqTrg = true;}
    // else if( (*TriggerPass)[112]==1 && (*TriggerPrescales)[112]==1 )      { h_selectBaselineYields_->Fill(26); passReqTrg = true;}
    if( (*TriggerPass)[116]==1 && (*TriggerPrescales)[116]==1 )      { h_selectBaselineYields_->Fill(27); passReqTrg = true;}
    ...
    else if( (*TriggerPass)[124]==1 && (*TriggerPrescales)[124]==1 )      { h_selectBaselineYields_->Fill(30); passReqTrg = true;}
    else if( (*TriggerPass)[110]==1 && (*TriggerPrescales)[110]==1 )      { h_selectBaselineYields_->Fill(31); passReqTrg = true;}
    else if( (*TriggerPass)[112]==1 && (*TriggerPrescales)[112]==1 )      { h_selectBaselineYields_->Fill(32); passReqTrg = true;}
