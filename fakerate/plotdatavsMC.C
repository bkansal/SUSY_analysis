...
void plotdatavsMC(TString varName,  TString year,  TString ntuples , bool ExpvsPred = true, bool SRvsCR=false)
{
  ...
  string lep="LL";
  TString path,path1;
  //path="final_rootfiles/FR/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_SFnopxveto_newbin2/";
  path="final_rootfiles/FR/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_noSF_newbin2/";
  path="../fakerate/rootout/new_noSF_v2/";
  path="rootout/";
  //  path="final_rootfiles/FR/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_SF_bSF_newbin2/";
  //path="../fakerate/rootout/fake_rate_v10_afterJERC/withoutJERC/";
   //path="../fakerate/rootout/fake_rate_v10_beforebtagSF/";
 ...
 else if(varName=="MET" || varName=="JetPt" || varName=="METvBin2")
    {
