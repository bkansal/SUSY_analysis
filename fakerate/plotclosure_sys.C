void plotclosure_sys(TString varName="AllSBins_v6_CD_EW_50bin",  TString year="full_Run2",  TString ntuples="v18" , bool ExpvsPred = true, bool SRvsCR=false)
//void plotclosure_sys(TString varName="AllSBins_v6_CD_EW_50bin",  TString year="full_Run2",  TString ntuples="v17" , bool ExpvsPred = true, bool SRvsCR=false)
//void plotclosure(TString varName="AllSBins_v6_CD_EW_50bin",  TString year="full_Run2",  TString ntuples="v18" , bool ExpvsPred =false, bool SRvsCR=true)
{
  //"AllSBins_v6_CD_EW_50bin","full_Run2","v18"
  ...
  if(ntuples=="v18")
    {
      ...
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v7/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_pxveto_SFapp/";
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v7/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_pxveto/";
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v8/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_noSF_newbin2/";
      path="rootout/new_noSF_v2/";
      //      path="rootout/fake_rate_v10_beforebtagSF/";
           path="rootout/fake_rate_v10_afterbtagSF_overlap_qmulticut/";
	    //         path="rootout/fake_rate_v10_beforebtagSF_overlap_SF/";
	    //            path="rootout/fake_rate_v10_afterbtagSF_v1/";
	    //     path="rootout/fake_rate_v10_afterbtagSF/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_SF_bSF_newbin2/";
     // path="rootout/fake_rate_v10_afterJERC/withoutJERC/";
    }
  else
    {
      //      path="./";
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v4/FR_using_PhoPtQmulti_nopix/";
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v7/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET/";
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v7/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_pxveto_SFpxveto/";
      path="/Users/bkansal/work/MET_Analysis/Analysis/fakerate/rootout/fake_rate_v7/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_SFnopxveto/";
  ...
  pred_sr->GetXaxis()->SetTitle("Bin no.");
    ...
    pred_sr     = (TH1D*)f2->Get("AllSBins_v7_CD_elec1_closure");
  pred_sr->GetXaxis()->SetTitle("Bin no.");
    ...
    if(ExpvsPred) pred_sr     = (TH1D*)f2->Get("AllSBins_v6_CD_elec1_closure");
    if(SRvsCR) pred_sr     = (TH1D*)f2->Get("AllSBins_v6_CD_elec1");
   ...
   c1 = new TCanvas("stackhist","stackhist",1000,600);
    ...
    if(SRvsCR)   pred_sr     = (TH1D*)f2->Get("AllSBins_v6_CD_EW_50bin_elec1_closure");
    pred_sr->GetYaxis()->SetTitle("Bin no.");
     
    bin=52;
    //    xmin=-100000,xmax = 100000,xmin_=0,xmax_=50;
    xmin=1,xmax = 46,xmin_=1,xmax_=46;
    ymin=-0.4 , ymax=0.4, ymin_=0.05 , ymax_=10000000, yset_=10;
    title="closure test using optimized search bins";
  pred_sr->SetTitle(0);
  }
  ...
  pred_sr->SetTitle(title);
    ...
    if(varName=="nJets")    rebin=1,xmin_=0,xmax_=14,xmin=0,xmax=14;
  ...
  pred_sr->SetTitle(title);
   ...
   for(int i=0;i<=53;i++) 
     { cout<<pred_sr->GetBinContent(i)<<endl;}//" +- "<<pred_sr->GetBinError(i)<<endl;} 
   cout<<"==============="<<endl;
  ...
  TPad *pad1 = new TPad("pad1","pad1",0,0,0.9,0.9);
  pad1->SetBottomMargin(0);
  pad1->SetBottomMargin(0.3);
  //TPad *pad1 = new TPad("pad1","pad1",0,0.9,1,0.1);
  TPad *pad2 = new TPad("pad1","pad1",0,0.0,1,0.91);
  pad2->SetTopMargin(0);
  ...
  pred_sr->GetXaxis()->SetRangeUser(xmin,xmax);
  sr->GetXaxis()->SetRangeUser(xmin,xmax);
  pred_sr->GetYaxis()->SetLabelSize(0.01);
  ...
  //  cout<<"==============="<<endl;
   ...
   TPaveStats *ptstats2 = new TPaveStats(0.80602,0.8,0.9,0.85,"brNDC");
  ...
  if(varName=="AllSBins_v6_CD_EW_50bin"  ){
    ...
    TArrow *arrow3 = new TArrow(14,50*yset_, 19,50*yset_,0.01,"<|>");
    TArrow *arrow4 = new TArrow(19,50*yset_, 24,50*yset_,0.01,"<|>");
    TArrow *arrow5 = new TArrow(24,50*yset_, 29,50*yset_,0.01,"<|>");
    TArrow *arrow6 = new TArrow(29,50*yset_, 34,50*yset_,0.01,"<|>");
    TArrow *arrow7 = new TArrow(34,50*yset_, 40,50*yset_,0.01,"<|>");
    TArrow *arrow8 = new TArrow(40,50*yset_, 46,50*yset_,0.01,"<|>");
    ...
    Tl.DrawLatex(14.0,2*50*yset_,"N^{ 0}_{ #geq7}");
    Tl.DrawLatex(20.0,2*50*yset_,"N^{ #geq1}_{ 2-4}");
    Tl.DrawLatex(25.0,2*50*yset_,"N^{ #geq1}_{ 5-6}");
    Tl.DrawLatex(30.0,2*50*yset_,"N^{ #geq1}_{ #geq7}");
    Tl.SetTextSize(0.04);
    Tl.DrawLatex(34,2*50*yset_,"EW : W tag");
    Tl.DrawLatex(40,2*50*yset_,"EW : H tag");
  ...
  // ptstats2->Draw();
   ...
   TH1D *h3 = (TH1D*)pred_sr->Clone("h3");
  TH1D *h4 = (TH1D*)sr->Clone("h4");
  ...
  if(ExpvsPred)  h3->GetYaxis()->SetTitle("(Pred-Exp)/Exp");
  ...
  TF1 *f=new TF1("f","[0]",xmin_,xmax_);
  h3->Fit(f,"R");

  cout<<"Chi2 = "<<f->GetChisquare()<<endl;
  cout<<"dof = "<<f->GetNDF()<<endl;
  cout<<"goodness od fit = "<<f->GetChisquare()/f->GetNDF()<<endl;
