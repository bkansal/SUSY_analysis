//void plot2dratio(TString varName="PhoPtQMultJet", TString year="full_Run2",bool ExpvsPred=true,bool SRvsCR=false, bool v2=false, bool lowdphi=false)
void plot2dratio(TString varName="PhoPtQMultJet", TString year="full_Run2",bool ExpvsPred=false,bool SRvsCR=true, bool v2=false, bool lowdphi=true)
{
  ...
  if(!lowdphi) {
     ...
     path="rootout/fake_rate_v10_afterbtagSF/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_nopxveto_noSF_nobSF_lowdphi_newbin2/";
     ...
     //      path="rootout/fake_rate_v8/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_lowdphi_nopxveto_noSF_newbin2/";
     //       path="rootout/fake_rate_v9/FR_using_PhoPtQmulti_csv_cut_EMObjeta_qmulti_METCaloMET_lowdphi_nopxveto_noSF_newbin2/";
     //        path="rootout/new_noSF_v2/";
     //     path="rootout/new/";
  }
  ...
  if(data)
    {
      pdf = "pdf/FR_"+varName+"_"+year+"_FR.pdf";
      png = "png/FR_"+varName+"_"+year+"_FR.png";
  ...
  else
    {
      ...
      png = "png/FR_"+varName+"_"+year+"_FR.png";
      if(lowdphi) {
	pdf = "pdf/FR_"+varName+"_"+year+"_lowdphi_FR.pdf";
	png = "png/FR_"+varName+"_"+year+"_lowdphi_FR.png";
      }
      if(year=="full_Run2")
	{
