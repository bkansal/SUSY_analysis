...
//void plotclosure(TString varName="AllSBins_v6_CD_EW_50bin",  TString year="full_Run2",  TString ntuples="v18" , bool ExpvsPred =false, bool SRvsCR=true)
{
  ...
  if(ntuples=="v18")
    {
      ...
      //            path="rootout/fake_rate_v10_beforebtagSF/";
            ...
            path="rootout/fake_rate_v10_closure/";
  ...
  pred_sr->GetYaxis()->SetTitleOffset(0.74);
  ...
  TLegend *legend = new TLegend(0.45,0.75,0.9,0.9);
  ...
  predsys->SetMarkerColor(kGray+6);
  predsys->SetFillColor(kGray+6);
