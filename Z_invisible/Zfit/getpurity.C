...
void getpurity(){
  ...
  TString yAxisLabel="#beta (DY/Total events)";
    TString path="../rootoutput/v6/withphicut_zmass60to120_data/";  
    TString path1="../rootoutput/v6/withphicut_zmass60to120_elec_muon_data/";
    TString path2="../rootoutput/v6/withphicut_zmass60to120_elec_muon/";	
    TString path3="../rootoutput/v6/withphicut_zmass60to120/";
    //    path="../tmp3/";
    // path1="../tmp3/";

    // path="../rootoutput/v3/withphicut_zmass60to120_data/";
    // path1="../rootoutput/v3/withphicut_zmass60to120_data/";
    // TString path2="../rootoutput/withphicut_zmass60to120_elec_muon_v1/";

    
    //   TString filename[4]={path+"ZJZGToLL_2016_CR_v18.root",path+"ZJZGToLL_2017_CR_v18.root",path+"ZJZGToLL_2018_CR_v18.root",path+"ZJZGToLL_CR_v18.root"};
    //  TString filename1[4]={path+"TTWZJZGToLL_2016_CR_v18.root",path+"TTWZJZGToLL_2017_CR_v18.root",path+"TTWZJZGToLL_2018_CR_v18.root",path+"TTWZJZGToLL_CR_v18.root"};
    //    TString filename[2]={path+"ZJZGToLL_2016_CR_v18.root",path+"Run2016_METdata_CR_v18.root"};
    // TString filename1[2]={path+"TTWZJZGToLL_2016_CR_v18.root",path1+"Run2016_METdata_CR_v18.root"};
    ...
    //    TString filename[2]={path+"TTG_CR_v18.root",path2+"Run2_Muondata_CR_v18.root"};
    // TString filename1[2]={path+"ZJZGToLL_CR_v18.root",path+"Run2_METdata_CR_v18.root"};
    //    TString filename[2]={path+"TTG_CR_v18.root",path2+"Run2_Muondata_CR_v18.root"};
    //    TString filename[2]={path+"ZJZGToLL_CR_v18.root",path+"Run2_METdata_CR_v18.root"};
    //TString filename1[2]={path+"TTWZJZGToLL_CR_v18.root",path1+"Run2_METdata_CR_v18.root"};
    TString filename[2]={path+"ZJZGToLL_CR_v18.root",path+"Run2_METdata_CR_v18.root"};
    TString filename1[2]={path+"TTWZJZGToLL_CR_v18.root",path1+"Run2_METdata_CR_v18.root"};
    //    TString filename[2]={path+"Run2_METdata_CR_v18.root"};
    //    TString filename1[2]={path1+"Run2_METdata_CR_v18.root"}  ;
    //   TString path="../rootoutput/withphicut_zmass60to120_data/";
  //   TString path1="../rootoutput/withphicut_zmass60to120_elec_muon_data/";

  //   TString filename[4]={path+"Run2016_METdata_CR_v18.root",path+"Run2017_METdata_CR_v18.root",path+"Run2018_METdata_CR_v18.root",path+"Run2_METdata_CR_v18.root"};
  // TString filename1[4]={path1+"Run2016_METdata_CR_v18.root",path1+"Run2017_METdata_CR_v18.root",path1+"Run2018_METdata_CR_v18.root",path1+"Run2_METdata_CR_v18.root"};
  ...
  for(int i=0;i<nfiles;i++){
    //    histName1.push_back("AllSBins_v6_CD_EW_7bin");
    //    histName2.push_back("AllSBins_v6_CD_EW_7bin");
    histName1.push_back("AllSBins_v6_CD");
    histName2.push_back("AllSBins_v6_CD");
    //    histName1.push_back("nBTags");
    //    histName2.push_back("nBTags");
    //   histName1.push_back("nJets");
    // histName2.push_back("nJets");
  ...
  for(int i=0;i<nfiles;i++){
    ...
    cA->SetGridx();
    cA->SetGridy();
    fout =new TFile("purityfactor.root","recreate");
    fout->cd();
    ...
    sprintf(leg,"#beta : %f +- %f",yg[0],h_grAE[i]->GetErrorYhigh(0));
