...
void plotdatavsMC_Zin(TString varName,  TString year,  TString ntuples , bool ExpvsPred = true, bool SRvsCR=false)
{
  ...
  path="rootoutput/v6/withphicut_zmass60to120_data/" , elec=false, muon=false;
 ...
 /* else  path="rootoutput/withphicut_zmass60to120_data/";     */
  ...
  if(ExpvsPred)
    {
      pdf = "pdf/Zin/Zin_"+varName+"_"+year+"_ExpvsPred.pdf";
      png = "png/Zin/Zin_"+varName+"_"+year+"_ExpvsPred.png";
    }
  else if(SRvsCR)
    {
 ...
 /*  cout<<"==============="<<endl; */
  ...
  hs_var->GetYaxis()->SetTitleSize(0.06);
  hs_var->GetYaxis()->SetTitleOffset(0.72);
  ...
  if(year=="full_Run2")
    intLumiE.DrawLatexNDC(0.67,0.91,"#bf{137 fb^{-1} (13 TeV)}");
