void plotclosure(TString varName,  TString year,  TString ntuples , bool ExpvsPred = true, bool SRvsCR=false)
{
  ...
  //  path="./rootoutput/withphicut_zmass60to120_btagdiscut/";
   // path="./rootoutput/withoutphicut/";
  ...
  //        path1="rootoutput/withphicut_zmass60to120_btagSF_muon/";
  //
     // path="rootoutput/withphicut_zmass60to120_btagSF_v2/";
     //  path="rootoutput/withphicut_zmass60to120_btagSF/v1/";
     //path="rootoutput/withphicut_zmass60to120_btagSF/btagclean_v1/";
     //   path="rootoutput/withphicut_zmass60to120_btagSF/btagDeepCSV_v1/";
  //  path="rootoutput/withphicut_zmass60to120_btagSF/Nbg0_NJ2to4/";
  //path="rootoutput/withphicut_zmass60to120_btagSF/Nbg0_NJ5to6/";
  //  path="rootoutput/withphicut_zmass60to120_btagSF/Nbg0_NJge7/";
  //  path="rootoutput/withphicut_zmass60to120_btagSF/Nb0_NJ4/";
  //    path="rootoutput/withphicut_zmass60to120_btagSF/Nb0_NJ4/";
  // path="rootoutput/withphicut_zmass60to120_btagSF/Nb0_NJ2to4/";
  // path="rootoutput/withphicut_zmass60to120_btagSF/Nb0_NJ5to6/";
  //  path="rootoutput/withphicut_zmass60to120_btagSF/Nb0_NJge7/";
  //path="rootoutput/withphicut_zmass60to120/";
   /* path1="rootoutput/withphicut_zmass60to120_btagSF_muon_tmp/"; */
     /*  path1="rootoutput/withphicut_zptcut200_btagSF_muon_tmp/"; */
  // path="rootoutput/withphicut_zptcut200_btagSF/";
  ...
  if(year == "full_Run2")
	...
	filename= path+a+"ToLL_CR_v18.root";
	filename1= path1+a+"ToLL_CR_v18.root";
      }
    }
  else
    {
      //            filename= path+"Run2016_METdata_CR_v18.root";
      if(ntuples=="v18")
	{
	  /* filename= "samples/ZGToNuNuG_"+year+"_CR_v18.root"; */
	  /* filename1= "samples/ZGToLLG_"+year+"_CR_v18.root"; */
	  filename= path+a+"ToNuNu_"+year+"_CR_v18.root";
	  filename1= path+a+"ToLL_"+year+"_CR_v18.root";
	  /* filename= path+"ZGToNuNuG_"+year+"_CR_v18.root"; */
	  /* filename1= path+"ZGToLLG_"+year+"_CR_v18.root"; */
	  /* filename= path+"ZGToLLG_"+year+"_CR_v18.root"; */
	  //           filename1= path+"DYJetsToLL_"+year+"_CR_v18.root";
	  //filename= path+"ZGToNuNuG_"+year+"_CR_v18.root";
	  //filename= path+"ZJetsToNuNu_"+year+"_CR_v18.root";
	}

      else
	{
	  filename= path+a+"ToLL_"+year+"_CR_v18.root";
	  filename1= path1+a+"ToLL_"+year+"_CR_v18.root";
  ...
  TString name;
  //  name="Run"+year+"_TF_Z_in_v6_CD";
  if(year=="full_Run2") name="Zinvisible_TF";
  else   name="Zinvisible_TF_"+year;
  ...
  else if(SRvsCR) varName2=varName+"_elec0";
  varName1=varName;
  //  varName1=varName;
  ...
  xmin_=1,xmax_=37,xmin=1,xmax = 37,bin=36;
   ...
   c1 = new TCanvas("stackhist","stackhist",1000,1000);
    ...
    if(ExpvsPred)   pred_sr     = (TH1D*)f2->Get(varName2);
    if(SRvsCR)   pred_sr     = (TH1D*)f2->Get(varName2);
    ...
    if(scale)
      ymin=0 , ymax=1.99, ymin_=0.005 , ymax_=10, yset_=10;
    else 
  ...
  pred_sr->SetTitle(0);
   ...
   c1 = new TCanvas("stackhist","stackhist",1000,1000);
    ...
    if(ExpvsPred)   pred_sr     = (TH1D*)f2->Get(varName2);
    if(SRvsCR)   pred_sr     = (TH1D*)f2->Get(varName);
    pred_sr->GetYaxis()->SetTitle("Bin no.");
  ...
  pred_sr->SetTitle(title);
   ...
   pred_sr->SetTitle(title);
 ...
 else if(varName=="nBTags" || varName=="nBTags_EW" || varName=="nBTags_SP" || varName=="h_deepcsv" || varName=="h_deepcsv_v2"|| varName=="h_deepcsv_v3"|| varName=="h_deepcsv_v4" || varName=="h_deepcsv_v1" ||varName=="nBTags_v1"||varName=="nBTags_v2"||varName=="nBTags_v3"  )
    {
      ...
      if(varName=="h_deepcsv_v4") title="hadronic Jets with bjetdeepCSV cut";
      c1 = new TCanvas("stackhist","stackhist",900,1200);
    cr          = (TH1D*)f1->Get(varName1);
    sr          = (TH1D*)f1->Get(varName1);
    pred_sr     = (TH1D*)f2->Get(varName1);
 ...
 for(int i=0;i<=14;i++)
  ...
  if(invMass_)
    {
      ...
      pad2 = new TPad("pad2","pad2",0,0,1,0);
    ...
    pad1 = new TPad("pad1","pad1",0,0.325,1,1);
  ...
  /* pad1->SetBottomMargin(0); */
  /* pad1->SetBottomMargin(0.3); */
  /* TPad *pad2 = new TPad("pad2","pad2",0,0,1,0); */
  ...
  pred_sr->GetYaxis()->SetTitleSize(0.06);
  pred_sr->GetYaxis()->SetTitleOffset(0.8);
  ...
  if(!invMass_){
    sprintf(chi1,"Total events = %f",integeral);
    sprintf(chi2,"Total events = %f",integeral2);
  }
  ...
  //  TLegend *legend1 = new TLegend(0.1,0.8,0.35,0.9);
  ...
  if(SRvsCR)
	...
	if(ntuples=="v18")
	  {
	    legend->AddEntry(pred_sr,"Z -> l^{+}l^{-} + #gamma ","lp");
	    legend->AddEntry(sr,"Z -> #nu #nu + #gamma ","lp");
	  }
	else
	  {
	...
	if(ntuples=="v18")
	  {
	  legend->AddEntry(pred_sr,"TF x Z -> l^{+}l^{-} + #gamma ","lp");
	  legend->AddEntry(sr,"Z -> #nu #nu + #gamma ","lp");
	  }
      }
  ...
  if(ntuples=="v18")
    {
      ...
      else if(SRvsCR) h3->GetYaxis()->SetTitle("Transfer factor");
    }
  else
  ...
  if(SRvsCR)  
    {
      ...
      else line = new TLine(xmin_,4,xmax_,4);
