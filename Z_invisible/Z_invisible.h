#ifndef Z_invisible_H
#define Z_invisible_H
#include <iostream>
#include <fstream>
#include <cmath>
#include <vector>
...
class Z_invisible : public NtupleVariables{

 public:
  Z_invisible(const TString &inputFileList="foo.txt", const char *outFileName="histo.root",const char *dataset="data");
  ~Z_invisible();
...
#ifdef Z_invisible_cxx

void Z_invisible::BookHistogram(const char *outFileName) {
...
Z_invisible::Z_invisible(const TString &inputFileList, const char *outFileName, const char* dataset) {
...
Bool_t Z_invisible::FillChain(TChain *chain, const TString &inputFileList) {
...
Long64_t Z_invisible::LoadTree(Long64_t entry) {
