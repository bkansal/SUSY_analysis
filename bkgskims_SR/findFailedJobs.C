...
void findFailedJobs(string arg){
  ...
  // char ofileStart[300]="/eos/uscms/store/user/bkansal/GMSB_skims_TreesV17/SignalRegion/SR_";
  char ofileStart[300]="/eos/uscms/store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV17/background/skims/SR_";
