void plotratio_LE_newselec_v2(TString title1, TString ntuples)
  {
  TFile *f1;
  //  bool LE=true;
  string lep="LE";
  ...
  if(ntuples=="v18")
    {
      ...
      //      path ="rootoutput/newselec_LE_noISRjet_METfilters_EW_hadjetID_v18/TF_v3/";
       //      path ="rootoutput/newselec_LM_noISRjet_METfilters_EW_hadjetID_v18/TF_v3_usingfullRun2/TTGJets_TF/";
      //      path="rootoutput/newselec_LE_noISRjet_METfilters_EW_hadjetID_newPU_v18/TF_v4_usingfullRun2/";
           path="rootoutput/newselec_LE_noISRjet_METfilters_EW_hadjetID_newPU_v18/TF_v5_usingfullRun2_BTagDeepCSV/";
      //      path="rootoutput/newselec_LM_noISRjet_METfilters_EW_hadjetID_newPU_v18/TF_v5_usingfullRun2_BTagDeepCSV/";
  ...
  //  string varName[1]={"AllSBins_v7_CD_SP_tmp"};
  ...
  for(int i=0; i<k;i++)
	...
	TF[i] = new TH1D("tf","Transfer factor for SP : NJets x Nbtag & EW : NJets x Nbtag",nbin,bin0,bin1);
      ...
      if(varName[i]=="AllSBins_v7_CD_SP"){
    	...
    	TLatex Tl,T2;
    	Tl.SetTextSize(0.06);
    	Tl.DrawLatex(1.25,0.47,"N^{ 0}_{ 2}");
    	Tl.DrawLatex(2.25,0.47,"N^{ 0}_{ 3}");
    	Tl.DrawLatex(3.25,0.47,"N^{ 0}_{ 4}");
    	Tl.DrawLatex(4.25,0.47,"N^{ 0}_{ 5-6}");
    	Tl.DrawLatex(5.25,0.47,"N^{ 0}_{ #geq7}");
    	Tl.DrawLatex(6.25,0.47,"N^{ #geq1}_{ 2-4}");
    	Tl.DrawLatex(7.25,0.47,"N^{ #geq1}_{ 5-6}");
    	Tl.DrawLatex(8.25,0.47,"N^{ #geq1}_{ #geq7}");
    	Tl.DrawLatex(9.25,0.47,"W tag");
    	Tl.DrawLatex(10.25,0.47,"H tag");
      ...
      if(lep=="LE")
    	{
    	  ...
    	  legend->AddEntry(sr,"0 e + #gamma SR","f");
    	  legend->SetTextSize(0.08);
    	}
      else if(lep=="LM")
    	{
    	  legend->AddEntry(cr,"1 #mu + #gamma CR  ","f");
    	  legend->AddEntry(sr,"0 #mu + had #tau + #gamma SR","f");
      ...
      else if( lep=="LL")
    	{
    	  ...
    	  /* legend->AddEntry(cr,"1 l + 1 photon CR","f"); */
    	  /* legend->AddEntry(sr,"0 l + 1 photon SR ","f"); */
    	  legend->SetTextSize(0.06);
    	}
      legend->Draw();
