...
void plotKinStack(){
  ...
  TString varName = "MET_nj1"; TString xLabel = "p_{T}^{miss} (GeV)";   int rebin=5; yMin=0.1,yMax = 15000; xMin=200.0,xMax = 1000;
  // TString varName = "BestPhotonPt"; TString xLabel = "p_{T}^{#gamma} (GeV)";   int rebin=10; yMin=0.4,yMax = 1000000; xMin=0.0,xMax = 1200;
  // TString varName = "PhovBin2"; TString xLabel = "p_{T}^{#gamma} (GeV)";   int rebin=1; yMin=0.4,yMax = 1000000; xMin=0.0,xMax = 1200;
   // TString varName = "nHadJets_nocut"; TString xLabel = "N_{ jets}";   int rebin=1; yMin=0.1,yMax = 1000; xMin=0.0,xMax = 20;
  //TString varName = "nJets"; TString xLabel = "N_{ jets}";   int rebin=1; yMin=0.1,yMax = 100000; xMin=0.0,xMax = 20;
  // TString varName = "nBTags"; TString xLabel = "N_{ b-jets}";   int rebin=1; yMin=0.1,yMax = 100000; xMin=1.0,xMax = 7;
  ...
  f[1] = new TFile("TTJetsHT_v17.root");//ZGJetsToNuNuG_v17.root
  // f[2] = new TFile("ZGZJ_NuNuG_v17.root");
  // f[2] = new TFile("ZJetsToNuNu_v17.root");
  f[2] = new TFile("ZGJetsToNuNuG_v17.root");
  ...
  // f[8] = new TFile("T5bbbbZg_1800_1750_FastSim_v17.root");
