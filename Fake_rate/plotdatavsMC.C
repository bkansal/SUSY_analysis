  ...
  if(varName=="nJets" || varName=="nvtx" || varName=="nJets_EW" ||varName=="nJets_SP"||varName=="Qmulti")
   {
     ...
     if(varName=="nJets")    rebin=1,xmin_=0,xmax_=15,xmin=0,xmax=15 , ymin=0 , ymax=2.99, ymin_=0.5 , ymax_=100000;
   ...
   pred_sr->SetTitle(title);
 ...
 else if(varName=="MET" || varName=="JetPt" || varName=="METvBin2")
    {
      ...
      if(varName=="MET")    xmin_=200,xmax_=1000,xmin=200,xmax=1000,rebin=5;
