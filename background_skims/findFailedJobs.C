...
void findFailedJobs(string arg){
  ...
  char ofileStart[300]="/eos/uscms/store/user/bkansal/GMSB_skims_TreesV17/SignalRegion/skims/SR_";
  //  char ofileStart[300]="/eos/uscms/store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV17/background/";
  // char ofileStart[300]="/eos/uscms/store/user/bkansal/GMSB_skims_TreesV17/for_bkg_estimation/lost_electron/new2/CR_";
