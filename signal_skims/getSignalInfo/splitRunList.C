...
void splitRunList(string infile,int nfPerJob){
  ...
  string exeAna     = "sigSampleInfo";
//  string datasetAna = "T5bbbbZG";
//  string filesToTransfer = "mGl_Xsecpb_pcUnc_absUnc.txt";
  // string datasetAna = "TChiWG";

   // string datasetAna = "TChiNG";
   // string filesToTransfer = "EWeakino_N2N1Xsec.root";
   //   string filesToTransfer = "EWeakino_Xsec.root";

   // string datasetAna = "T5ttttZG";
   // string filesToTransfer = "mGl_Xsecpb_pcUnc_absUnc.txt";

   string datasetAna = "T6ttZG";
   string filesToTransfer = "mstop_Xsec_pbUnc.txt";


  // string datasetAna = "T5qqqqHg";
