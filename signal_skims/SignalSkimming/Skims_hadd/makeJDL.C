...
void makeJDL(){
  ...
  string filesToTransfer = "numEventsComp.C,T6ttZG_Summer16v3_MassScan.root";
  //  string filesToTransfer = "numEventsComp.C,T5ttttZG_Summer16v3Fast_MassScan.root";
  //  string filesToTransfer = "numEventsComp.C,TChiNG_Summer16v3_MassScan.root";
  // string filesToTransfer = "numEventsComp.C,T5bbbbZg_MassScan.root";
  // string filesToTransfer = "numEventsComp.C,T5bbbbZg_MassScan.root,T5qqqqHg_MassScan.root,T5ttttZg_MassScan.root,TChiNG_MassScan.root,TChiWG_MassScan.root,T6ttZg_MassScan.root";
  //  string dataset="TChiNG";
  //  string dataset="TChiNG";
  // string dataset="T5ttttZg";
  string dataset="T6ttZg";
  ...
  //  TFile *f1 = new TFile("TChiNG_Summer16v3_MassScan.root");
