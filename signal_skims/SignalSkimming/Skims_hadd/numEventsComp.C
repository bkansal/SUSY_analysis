...
void numEventsComp(){
  ...
  TString fName1,fName="root://cmseos.fnal.gov//store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV17/signals/unskimmed_SortedSignalscans/scan_2017";
  TFile *f1;
  //  TFile *f2= TFile::Open("TChiNG_MassScan.root");
  //  TFile *f2= TFile::Open("T5bbbbZg_MassScan.root");
  //  TFile *f2= TFile::Open("T5bbbbZG_Autumn18Fast.SMS-T5bbbbZg_TuneCP2_13TeV-madgraphMLM-pythia8_job0.root");
  TFile *f2= TFile::Open("TChiNG_Summer16v3Fast.SMS-TChiNG_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_job0.root");
  TH1D *h1;
...
//bool numEventsComp(TString inFile,double mp,double md){
  TFile *f1= TFile::Open(inFile);
  TFile *f2= TFile::Open("T5qqqqHg_Summer16v3_MassScan.root");
  //  TFile *f2= TFile::Open("TChiNG_Fall17_MassScan.root");
  //  TFile *f2= TFile::Open("T5bbbbZg_MassScan.root");
  //  TFile *f2= TFile::Open("T5bbbbZG_Autumn18Fast.SMS-T5bbbbZg_TuneCP2_13TeV-madgraphMLM-pythia8_job0.root");
  //  TFile *f2= TFile::Open("TChiNG_Summer16v3Fast.SMS-TChiNG_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_job0.root");
  ...
  if(abs(entries2-entries1) < 0.1){
    ...
    //    sprintf(cmd1,"eos root://cmseos.fnal.gov rm /store/user/vhegde/GMSB_skims_ST_RA2b_TreesV12/SignalRegion_v1/skimmed_SortedSignal_bTagEff/T5ChiNG_%.0f_%.0f_*pythia8_job*.root",mp,md);
       sprintf(cmd1,"eos root://cmseos.fnal.gov rm /eos/uscms/store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV17/signals/unskimmed_SortedSignalscans/tmp1/scan_2016/T5qqqqHg_%.0f_%.0f_*pythia8_job*.root",mp,md);
    //    sprintf(cmd1,"rm /eos/uscms/store/group/lpcsusyhad/SusyPhotonMET/Run2ProductionV17/signals/unskimmed_SortedSignalscans/scan_2017/TChiNG_%.0f_%.0f_*pythia8_job*.root",mp,md);
