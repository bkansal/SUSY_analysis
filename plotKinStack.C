...
void plotKinStack(){
  ...
  TString varName = "MET"; TString xLabel = "p_{T}^{miss} (GeV)";   int rebin=10; yMin=0.1,yMax = 1000; xMin=100.0,xMax = 1400;
  ...
  f[3] = new TFile("WGJetsToLNuG_2016_v17.root");
  f[4] = new TFile("WJetsToLNu_2016_v17.root");
  f[5] = new TFile("GJetsQCD_new_2016_v17.root");
  col.resize(0);
