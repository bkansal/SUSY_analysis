...
// Tue Oct 13 06:49:40 2020 by ROOT version 6.12/07
// from TTree PreSelection/PreSelection
// found on file: /eos/uscms/store/user/bkansal/GMSB_skims_TreesV18/for_bkg_estimation/lost_electron/CR_Summer16v3.TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8_v18.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/bkansal/GMSB_skims_TreesV18/for_bkg_estimation/lost_electron/CR_Summer16v3.TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8_v18.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/bkansal/GMSB_skims_TreesV18/for_bkg_estimation/lost_electron/CR_Summer16v3.TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8_v18.root");
      }
