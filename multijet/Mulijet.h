...
class Mulijet : public NtupleVariables{
 ...
 public:
  ...
  vector<double>  njets={2,3,4,5,6,20};
  vector<double> metbin={200,300,2000};
...
void Mulijet::BookHistogram(const char *outFileName) {
  ...
  h_SBins_v6_CD_EW_7bin_A = new TH1D("AllSBins_v6_CD_EW_7bin_A","search bins v6:[(WTag : [65,105])]",4,1,5);
  ...
  h2_nJetsMET_A=new TH2D("nJetsMET_A","x: nJets vs MET",njets.size()-1,&(njets[0]),metbin.size()-1,&(metbin[0]));
  h_SBins_v6_CD_EW_50bin_A = new TH1D("AllSBins_v6_CD_EW_50bin_A","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",51,0,51);
  ...
  h_SBins_v6_CD_EW_7bin_B = new TH1D("AllSBins_v6_CD_EW_7bin_B","search bins v6:[(WTag : [65,105])]",4,1,5);
  h_SBins_v7_CD_SP_B = new TH1D("AllSBins_v7_CD_SP_B","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11);
  h2_nJetsMET_B=new TH2D("nJetsMET_B","x: nJets vs MET",njets.size()-1,&(njets[0]),metbin.size()-1,&(metbin[0]));
  h_SBins_v6_CD_EW_50bin_B = new TH1D("AllSBins_v6_CD_EW_50bin_B","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",51,0,51);
  ...
  h_SBins_v6_CD_EW_7bin_C = new TH1D("AllSBins_v6_CD_EW_7bin_C","search bins v6:[(WTag : [65,105])]",4,1,5);
  h_SBins_v7_CD_SP_C = new TH1D("AllSBins_v7_CD_SP_C","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11);
  h2_nJetsMET_C=new TH2D("nJetsMET_C","x: nJets vs MET",njets.size()-1,&(njets[0]),metbin.size()-1,&(metbin[0]));
  h_SBins_v6_CD_EW_50bin_C = new TH1D("AllSBins_v6_CD_EW_50bin_C","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",51,0,51);
  ...
  h_SBins_v6_CD_EW_7bin_D = new TH1D("AllSBins_v6_CD_EW_7bin_D","search bins v6:[(WTag : [65,105])]",4,1,5);
  h_SBins_v7_CD_SP_D = new TH1D("AllSBins_v7_CD_SP_D","search bins SP:[0b,1b] x [(NJ=2to4),(NJ:5or6),(NJ>=7)] + EW : Wtag & Htag",10,1,11);
  h2_nJetsMET_D=new TH2D("nJetsMET_D","x: nJets vs MET",njets.size()-1,&(njets[0]),metbin.size()-1,&(metbin[0]));
  h_SBins_v6_CD_EW_50bin_D = new TH1D("AllSBins_v6_CD_EW_50bin_D","search bins v6:[(WTag : [65,105]),(HTag : [105,140])]",51,0,51);
