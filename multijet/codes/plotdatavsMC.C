...
void plotdatavsMC(TString varName,TString ntuples="v17", TString year="full_Run2", bool ExpvsPred =false, bool SRvsCR=true)
{  
  TFile *f1, *f2,*f3, *f_0,*f_1,*f_2,*f_3,*f_4,*f_5;
  TString path,path1;
  path="rootoutput/Kvalid/";
  TLatex textOnTop,intLumiE;
 
  TString filename,filename1,filename2,filename3,filename4,filename5,filename6,filename7;
  if(year == "full_Run2")
    {
      filename= path+"Run2_METdata.root";
      filename1= path+"Run2_MC.root";
      filename2= path+"ZGZJ_NuNuG_v18.root";
      filename3= path+"TTGJets_v18.root";
      filename4= path+"WGJetsToLNuG_v18.root";
      filename5= path+"TTJetsHT_v18.root";
      filename6= path+"WJetsToLNu_v18.root";
      filename7=path+"GJetsQCD_new_v18.root";
    }
  else {
      filename= path+"Run2_METdata.root";
      filename1= path+"Run2_MC.root";
  ...
  f_0 = new TFile(filename2);
  f_1 =new TFile(filename3);
  f_2 =new TFile(filename4);
  f_3 =new TFile(filename5);
  f_4 =new TFile(filename6);
  f_5=new TFile(filename7);  
  ...
  h_5=(TH1D*)f_5->FindObjectAny(varName2);
 ...
 /*  cout<<"==============="<<endl; */
  ...
  double integeral=h_2->Integral() + h_3->Integral();
